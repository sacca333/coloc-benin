...
export const authApi = {
  register: (data: {
    ...
    typeCompte: 'ETUDIANT' | 'AUTRE';
    profession?: string;
    telephone?: string; ville?: string;
    universite?: string; filiere?: string; niveau?: string;
...
export const abonnementsApi = {
  ...
  confirmerFedapay: (transactionId: string | number) =>
    api.post('/abonnements/confirmer-fedapay', { transactionId }),
};
