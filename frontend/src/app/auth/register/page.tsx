    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="card max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500">Vérifiez votre email pour activer votre compte.</p>
          <Link href="/auth/login" className="btn-primary block mt-4 text-center text-sm">
            Se connecter
          </Link>
        </div>
      </div>
