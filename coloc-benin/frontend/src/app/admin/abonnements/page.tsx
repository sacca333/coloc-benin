...
export default function AdminAbonnements() {
    ...
    const exportCSV = () => {
        window.open(process.env.NEXT_PUBLIC_API_URL + '/admin/abonnements/export', '_blank');
    };

    const revenusPage = data.abonnements
                                ...
                                <tr key={a.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)', transition: 'background .15s' }}
                                    ...
                                    <td style={{ padding: '10px 14px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                                            {a.utilisateur?.photo ? <img src={photoUrl(a.utilisateur.photo)} alt="" style={{ width: 34, height: 34, borderRadius: '50%', objectFit: 'cover' }} /> : (
                                    ...
                                    <td style={{ padding: '10px 14px', fontSize: 14, fontWeight: 800, color: '#F59E0B', fontFamily: "'JetBrains Mono',monospace" }}>
